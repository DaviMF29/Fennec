        ...
        "/api/post/{id}": {
            ...
            "put": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Bad request - Missing ID or fields in request",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "403": {
                        "description": "Forbidden - User does not own post",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error - Unable to delete post",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/api/user/{id}": {
            ...
            "put": {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "Forbidden - Unauthorized to update these fields",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
